...
## File description -------------------------------------------------------------
## Sherlock expects job files in the format like
## http://sherlock.stanford.edu/mediawiki/index.php/SLURMSubmit
##
## Since we often want to run the same command but with many different
## parameters, we need to create many of these batch scripts. This makes that
## process simple (just writes a new batch script to file).
##
